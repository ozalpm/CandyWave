...
namespace Hertzole.GoldPlayer
{
    ...
    public sealed class PlayerAudio : PlayerModule
    {
        ...
        public UnityEvent FootstepsSource { get { return footstepsSource; } set { footstepsSource = value; } }
        /// <summary> The audio source where all the jump sounds will be played. </summary>
        public UnityEvent JumpSource { get { return jumpSource; } set { jumpSource = value; } }
        /// <summary> The audio source where all the land sounds will be played. </summary>
        public UnityEvent LandSource { get { return landSource; } set { landSource = value; } }
